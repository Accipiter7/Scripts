...
#Fetch sources
git clone --depth 1 https://github.com/KudProject/kernel_xiaomi_msm8953-4.9 wahoo
git clone --depth 1 https://github.com/kdrag0n/proton-clang.git pclang
git clone --depth 1 https://github.com/offset1313/AnyKernel3 -b mido ak3

# Set Build Env
IMG=/wahoo/out/arch/arm64/boot/Image.gz-dtb
BID=994392367:AAFOYQ-8ivJRIKA4v0BPLbnWpt3XVz3IIqs
GID=-1001313600106 
